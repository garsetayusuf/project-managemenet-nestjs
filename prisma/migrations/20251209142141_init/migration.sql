...
-- CreateIndex
CREATE INDEX "project_user_idx" ON "projects"("user_id");

-- CreateIndex
CREATE INDEX "task_project_idx" ON "tasks"("project_id");

-- CreateIndex
CREATE INDEX "task_user_idx" ON "tasks"("user_id");
...
-- CreateIndex
CREATE INDEX "refresh_token_expiry_idx" ON "refresh_tokens"("expires_at");

-- CreateIndex
CREATE INDEX "refresh_token_revoked_idx" ON "refresh_tokens"("revoked_at");
...
-- CreateIndex
CREATE INDEX "token_blacklist_expiry_idx" ON "token_blacklist"("expires_at");
